...
public class ViewPanel extends JPanel implements Observer
{
    ...
    final BufferedImage logo = ImageIO.read(new File("C:\\Users\\Clément\\Pictures\\Cesi_Logo_INGENIEUR_RVB-360x213.png"));
    ...
    public void paintVehiculeData(Graphics2D graphics2D)
    {
        ...
        graphics2D.drawString("Prochain point : " + this.model.getVehicles().get(0).getActualPosition().getDestination().getId(), 15, 850);
